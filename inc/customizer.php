...
class dcc_2015_Customize {
	...
	*/
	public static function register( $wp_customize ) {
		...
		// New Section
		$sectargs['title'] 			= __( 'DCC Options', 'dcc-marketing' );
		$sectargs['capability'] 	= 'edit_theme_options';
		$sectargs['description'] 	= __( 'Options for the DCC 2015 theme', 'dcc-marketing' );
		...
		$controlargs['label'] 				= __( 'Default Background', 'dcc-marketing' );

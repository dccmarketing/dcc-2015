...
?><div class="authorbox">
	<div class="authorbox-header">
		...
		<h4 class="authorbox-name"><?php printf( esc_attr__( '%s', 'dcc-2015' ), get_the_author() );?></h4>
	</div>
	...
	<div class="authorbox-blog-link">
		<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php
			...
			printf( __( 'View all posts by %s <span class="meta-nav">&rarr;</span>', 'dcc-2015' ), get_the_author() );
